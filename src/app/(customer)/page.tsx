      ...
      <div className="relative h-full w-full flex items-center justify-center px-4">
        <div className="w-full max-w-xl space-y-3 text-center -mt-16">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl font-semibold">Lovable-like app builder</h1>
            <p className="text-muted-foreground text-sm">
              Describe a landing or CRUD app and get a generated project, build,
              preview URL, and zip artifact.
            </p>
          </div>
          <div className="mx-auto w-full max-w-[480px] space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              OlyneroAI v0.1 focuses on landing pages and CRUD starters.
            </p>
          </div>
        </div>
      </div>
